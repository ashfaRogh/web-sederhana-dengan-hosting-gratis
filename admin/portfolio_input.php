...
if (isset($_POST['simpan'])) {
    ...
    if (empty($error)) {
        if($foto_name){
            ...
            $foto_name = "portfolio_".time()."_".$foto_name;
        ...
        if($id != ""){
            $sql1   = "update portfolio set nama = '$nama',foto='$foto_name',isi='$isi',tgl_isi=now() where id = '$id'";
        }else{
            $sql1       = "insert into portfolio(nama,foto,isi) values ('$nama','$foto_name','$isi')";
        }
...
?>
<h1>Halaman Admin Input Data Portfolio</h1>
<div class="mb-3 row">
    <a href="portfolio.php">
        << Kembali ke halaman admin Portfolio</a>
</div>
<?php
if ($error) {
?>
