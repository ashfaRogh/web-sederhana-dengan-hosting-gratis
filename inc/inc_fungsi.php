...
function portfolio_foto($id){
    ...
    if($foto){
        ...
        return 'portfolio_default_picture.png';
    }
}

function buat_link_portfolio($id){
    global $koneksi;
    $sql1    = "select * from portfolio where id = '$id'";
    $q1     = mysqli_query($koneksi,$sql1);
    $r1     = mysqli_fetch_array($q1);
    ...
    // http://localhost/website-company-profile/halaman.php/8/judul
    return url_dasar()."/portfolio.php/$id/$nama";
}

function microcontroller_foto($id){
    global $koneksi;
    ...
    if($foto){
        ...
        return 'microcontroller_default_picture.png';
    }
}

function buat_link_microcontroller($id){
    global $koneksi;
    $sql1    = "select * from microcontroller where id = '$id'";
    $q1     = mysqli_query($koneksi,$sql1);
    $r1     = mysqli_fetch_array($q1);
    $nama  = bersihkan_judul($r1['nama']);
    // http://localhost/website-company-profile/halaman.php/8/judul
    return url_dasar()."/microcontroller.php/$id/$nama";
}
...
function kirim_email($email_penerima, $nama_penerima,$judul_email,$isi_email){
    ...
    $email_pengirim     = "yura092020@gmail.com";
    ...
    try {
        ...
        $mail->Password   = 'guwhebat89';                               //SMTP password
