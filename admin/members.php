    ...
    <tbody>
        ...
        if ($password != '') {
            ...
            for ($x = 0; $x < count($array_password); $x++) {
                $sqlcari[] = "(nama_lengkap like '%" . $array_password[$x] . "%' or email like '%" . $array_password[$x] . "%')";
            }
...
<nav aria-label="Page navigation example">
    <ul class="pagination">
        ...
        for($i=1; $i <= $pages; $i++){
            ?>
            <li class="page-item">
                <a class="page-link" href="members.php?password=<?php echo $password?>&cari=<?php echo $cari?>&page=<?php echo $i ?>"><?php echo $i ?></a>
            </li>
            <?php
        }
        ?>
