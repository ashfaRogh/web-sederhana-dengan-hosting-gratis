...
<head>
    ...
    <title>Roghib's Road to Success.</title>
    <link rel="stylesheet" href="<?php echo url_dasar()?>/css/style.css">
</head>
<body>
    <nav>
        <div class="wrapper">
            <div class="logo"><a href='<?php echo url_dasar()?>'>Roghib's Road to Success.</a></div>
            <div class="menu">
                <ul>
                    <li><a href="<?php echo url_dasar()?>#home">Home</a></li>
                    <li><a href="<?php echo url_dasar()?>#courses">Courses</a></li>
                    <li><a href="<?php echo url_dasar()?>#portfolio">Portfolio</a></li>
                    <li><a href="<?php echo url_dasar()?>#microcontroller">Microcontroller</a></li>
