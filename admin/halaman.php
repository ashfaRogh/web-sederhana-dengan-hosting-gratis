...
<form class="row g-3" method="get">
    <div class="col-auto">
        <input type="text" class="form-control" placeholder="Masukkan Password" name="password" value="<?php echo $password ?>" />
    </div>
    <div class="col-auto">
    ...
    <tbody>
        ...
        if ($password != '') {
            ...
            for ($x = 0; $x < count($array_password); $x++) {
                $sqlcari[] = "(judul like '%" . $array_password[$x] . "%' or kutipan like '%" . $array_password[$x] . "%' or isi like '%" . $array_password[$x] . "%')";
            }
...
<nav aria-label="Page navigation example">
    <ul class="pagination">
        ...
        for($i=1; $i <= $pages; $i++){
            ?>
            <li class="page-item">
                <a class="page-link" href="halaman.php?password=<?php echo $password?>&cari=<?php echo $cari?>&page=<?php echo $i ?>"><?php echo $i ?></a>
            </li>
            <?php
        }
        ?>
